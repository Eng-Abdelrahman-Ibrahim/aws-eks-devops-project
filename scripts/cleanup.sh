...
# Handles all common blockers for VPC deletion
...
echo "[Step 1/6] Hunting for ALL orphaned Auto Scaling Groups for cluster '$CLUSTER_NAME'..."
...
# --- Step 2: EKS Clusters ---
echo "[Step 2/6] Hunting for ALL EKS clusters named '$CLUSTER_NAME'..."
...
echo "[Step 3/6] Cleaning up EKS OIDC Provider..."
...
echo "[Step 4/6] Cleaning up IAM Roles and Policies..."
...
echo "[Step 5/6] Hunting for ALL VPCs tagged '$VPC_NAME_TAG'..."
...
echo "[Step 6/6] Cleaning up EKS Access Entries and other resources..."
...
echo "[Final Step] Deleting local Terraform state files..."
